...
class DataService {
    ...
    func fetchGoalsForRunners(runner: String, season: String, completition: @escaping (Result<GoalsResponse, Error>) -> Void) {
        var componentUrl = URLComponents()
        componentUrl.scheme = "https"
        componentUrl.host = baseUrlString
        ...
        URLSession.shared.dataTask(with: validURL) { (data, response, error) in
            ...
            do {
                let response = try JSONDecoder().decode(GoalsResponse.self, from: validData)
                print(response)
                completition(.success(response))
            } catch let serializationError {
                completition(.failure(serializationError))
    ...
    func createGoalForRunner(runner: String, season: String, goalElements: [GoalElement], completition: @escaping (Result<GoalsResponse, Error>) -> Void) {
    ...
    func deleteGoalForRunner(runner: String, season: String, goalElements: [GoalElement], completition: @escaping (Result<GoalsResponse, Error>) -> Void) {
