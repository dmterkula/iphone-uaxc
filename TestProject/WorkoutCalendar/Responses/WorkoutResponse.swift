...
struct Workout: Codable, Identifiable {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case paceAdjustment = "targetPaceAdjustment"
    ...
    static var sampleWorkouts: [Workout] {
        return [
            Workout(date: Date().diff(numDays: 4), type: "Interval", title: "800m repeats", description: "6-7x 800s at goal pace", targetDistance: 800, targetCount: 6, pace: "goal", duration: "", icon: "🦁", uuid: UUID.init(uuidString: "962c7f4c-2079-40c9-ada1-02b45e3dcbee")!, paceAdjustment: ""),
            Workout(date: Date().diff(numDays: 11), type: "Interval", title: "Mile Repeats", description: "Mile repeats @PR pace", targetDistance: 1609, targetCount: 3, pace: "goal", duration: "", icon: "📌", uuid: UUID.init(uuidString: "37c1fe19-7e5c-4a45-a58a-00dc39f7e758")!, paceAdjustment: "")
